...
export const metadata: Metadata = {
  title: "QR Code by teag.me | Scan safely, create and track",
  description: "Scan QR codes safely, create shareable codes, and make editable tracked teag.me QR codes on iPhone.",
  openGraph: {
    title: "QR Code by teag.me | Scan safely, create and track",
    description: "A private iPhone QR app for destination previews, code creation, tracked links, photo scanning, and optional history sync.",
    url: "/scanner",
    type: "website",
  },
};
...
const FEATURES = [
  ...
  { number: "02", title: "Create and share", body: "Turn any website into a clean QR code, then save it to Photos or share it straight from your iPhone." },
  { number: "03", title: "Track with teag.me", body: "Sign in to create editable teag.me codes with scan analytics. Free includes 10 active codes; Pro makes them unlimited." },
];

const SHOTS = [
  { src: "/scanner/screenshots/01_scan.png", alt: "QR Code by teag.me framing a QR code", className: "lg:-rotate-2" },
  { src: "/scanner/screenshots/02_link.png", alt: "QR Code by teag.me showing the real URL before opening", className: "lg:translate-y-10 lg:rotate-2" },
  { src: "/scanner/screenshots/03_history.png", alt: "QR Code by teag.me URL history synced to teag.me", className: "lg:-rotate-1" },
  { src: "/scanner/screenshots/04_photo.png", alt: "QR Code by teag.me decoding a QR code from Photos", className: "lg:translate-y-10 lg:rotate-1" },
  { src: "/scanner/screenshots/05_privacy.png", alt: "QR Code by teag.me camera permission screen", className: "lg:-rotate-2" },
];
  ...
  return (
    <main className="w-full overflow-hidden bg-[#F5F2EA] text-[#15181F]">
      <nav className="full-bleed flex items-center justify-between py-6">
        <Link href="/scanner" aria-label="QR Code by teag.me home"><ScannerWordmark /></Link>
      ...
      <section className="full-bleed grid items-center gap-12 pb-20 pt-10 lg:grid-cols-[0.9fr_1.1fr] lg:pb-28 lg:pt-16">
        <div className="relative z-10 animate-teag-rise">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#0F7BFF]/20 bg-[#0F7BFF]/[0.08] px-3 py-1.5 font-mono text-[11px] tracking-[0.12em] text-[#0F7BFF]">
            <span className="h-1.5 w-1.5 rounded-full bg-[#FF8A3D]" /> SCAN SAFELY · CREATE · TRACK
          </div>
          <h1 className="max-w-[680px] font-heading text-[50px] font-extrabold leading-[0.94] tracking-[-0.05em] sm:text-[68px] lg:text-[76px]">One QR app. <span className="text-[#0F7BFF]">Scan and create.</span></h1>
          <p className="mt-7 max-w-[560px] text-lg leading-[1.6] text-[#4A505C] sm:text-xl">Reveal where a code goes before opening it—or make your own and track every scan with teag.me.</p>
          <div className="mt-9 flex flex-wrap items-center gap-4">
            <AppStoreBadge href={STORE_URL} />
            <div className="font-mono text-[11px] leading-[1.6] tracking-[0.04em] text-[#717784]">FREE TO SCAN + CREATE<br />NO ACCOUNT REQUIRED</div>
          </div>
          <div className="mt-9 flex flex-wrap gap-2.5 text-xs font-medium text-[#4A505C]">
            {['On-device decode', 'Create QR codes', 'Tracked teag.me links'].map((item) => <span key={item} className="rounded-full border border-[#15181F]/10 bg-white/60 px-3 py-2">✓ {item}</span>)}
          </div>
        </div>
        ...
        <div className="relative mx-auto h-[650px] w-full max-w-[640px] sm:h-[760px]">
          ...
          <Image src="/scanner/screenshots/01_scan.png" alt="QR Code by teag.me reading a QR code" width={1320} height={2868} priority className="absolute left-[4%] top-[8%] w-[42%] -rotate-6 rounded-[24px] shadow-[0_35px_90px_rgba(17,24,39,0.25)]" />
          <Image src="/scanner/screenshots/02_link.png" alt="QR Code by teag.me previewing a decoded destination" width={1320} height={2868} priority className="absolute right-[3%] top-0 w-[47%] rotate-6 rounded-[28px] shadow-[0_40px_100px_rgba(17,24,39,0.3)]" />
      ...
      <section id="features" className="bg-[#15181F] text-[#FFFDF8]">
        <div className="full-bleed py-20 lg:py-28">
          <div className="mb-12 grid gap-6 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
            ...
            <h2 className="font-heading text-[40px] font-extrabold leading-[1] tracking-[-0.04em] sm:text-[54px]">Everything you actually need from a QR code.</h2>
          </div>
      ...
      <section className="full-bleed py-20 lg:py-28">
        <div className="mb-12 max-w-[720px]">
          ...
          <h2 className="mt-4 font-heading text-[40px] font-extrabold leading-[1] tracking-[-0.04em] sm:text-[54px]">Scan, create, and keep useful history.</h2>
      ...
      <section id="pricing" className="full-bleed pb-20 lg:pb-28">
        <div className="grid overflow-hidden rounded-[28px] bg-[#0F7BFF] text-white lg:grid-cols-[1.2fr_0.8fr]">
          <div className="p-8 sm:p-12 lg:p-16">
            ...
            <h2 className="mt-5 max-w-[620px] font-heading text-[40px] font-extrabold leading-[1] tracking-[-0.04em] sm:text-[54px]">Scanning and static codes stay free. Pro powers tracking.</h2>
            <p className="mt-5 max-w-[590px] text-base leading-[1.7] text-white/80">No account is required to scan or create a static code. A free account syncs 100 URL captures and includes 10 active dynamic QR codes on teag.me.</p>
          </div>
